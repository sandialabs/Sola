...
\end{align}
\end{subequations}
Making appropriate choices for the prior distributions, sampling from the posterior distribution, and propagating the result through the product $\bftheta\mapsto\H^{-1}\B\bftheta$ for \cref{eq:control-update} is nontrivial
...
For our purposes, the key observation is the minimal amount of information that must be provided by a user in order to fully specify the problem:
\SM{TODO}
