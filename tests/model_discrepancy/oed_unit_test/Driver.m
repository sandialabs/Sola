...
Z_prior_samples = oed_interface.Compute_Prior_Samples(30);
...
%%
reg_coeffs = (10.^(-4:-1:-6))';
[beta_lcurve, Z_lcurve, post_var_lcurve, reg_val_lcurve] = md_oed.L_Curve_Analysis(beta_0, alpha_d, reg_coeffs);
Z_random = md_oed.Generate_Random_Design(N);
Z_random_subspace = md_oed.Generate_Random_Design_from_Subspace(N);
