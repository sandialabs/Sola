...
classdef MD_u_Prior_Interface_synthetic_test_OED < MD_u_Prior_Interface
    ...
    methods (Access = public)
        ...
        function [lambda_js] = Get_W_u_Generalized_Eigenvalues(this)
            lambda_js = eig((this.W_u + this.W_u') / 2, (this.M + this.M') / 2, 'chol');
        end
    ...
    methods
        ...
        function this = MD_u_Prior_Interface_synthetic_test_OED(m)
            this.m = m;
