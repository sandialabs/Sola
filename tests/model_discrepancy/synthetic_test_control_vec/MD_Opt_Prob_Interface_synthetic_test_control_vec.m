...
classdef MD_Opt_Prob_Interface_synthetic_test_control_vec < MD_Opt_Prob_Interface
    ...
    methods
        ...
        function this = MD_Opt_Prob_Interface_synthetic_test_control_vec(m)
            this.m = m;
