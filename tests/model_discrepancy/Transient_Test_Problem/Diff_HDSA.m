classdef Diff_HDSA < HDSA_Sabl_MD_Interface_Elliptic_Prior
    ...
    methods
        ...
        function this = Diff_HDSA(con_opt_obj, alpha_u, alpha_z, hdsa_trans_cov)
            this@HDSA_Sabl_MD_Interface_Elliptic_Prior(con_opt_obj, alpha_u, alpha_z, hdsa_trans_cov);
            ...
            num_sing_vals = con_opt_obj.con.n_y;
            oversampling = 0;
            num_subspace_iters = 1;
            u_vec = zeros(con_opt_obj.con.n_y, 1);
