classdef Adv_Diff_Gaussian_Source_Constraint < Dynamic_Constraint
    ...
    methods (Access = public)
        ...
        function this = Adv_Diff_Gaussian_Source_Constraint(n_y, n, T, n_t, num_space_control_nodes, diff_coeff, vel_coeff)
            ...
            % Spatially discretized PDE: M f(y,z) = -Ay + MBz,  A = diff_coeff * S + vel_coeff * V
            A = diff_coeff * S + vel_coeff * V;
            this.A = A;
            this.M = M;
            this.S = S;
