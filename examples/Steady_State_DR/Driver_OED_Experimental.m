...
D = md_post_sampling.post_data.D; % True Discrepancy
...
Z_prior_samps = md_oed.Generate_Random_Design(20);
...
plot(x, z_lofi, "DisplayName", "Lo-Fi Sol.");
plot(x, z_hifi, "DisplayName", "Hi-Fi Sol.");
plot(x, z_update_mean, "DisplayName", "Updated Sol.");
title("Lo-Fi & Hi-Fi Controls");
legend("Location", "best");
% z_prior_samples_w = z_prior_interface.Sample_with_Covariance_W_z_Inverse(10);
% figure;
