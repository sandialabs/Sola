...
md_oed.data_interface = data_interface;
...
for k = 1:N
    ...
    switch oedMethod
        case "load-stdOED"
            data_interface = MD_Data_Interface_Diff_React(k, 1, 'OED');
...
plot([0:N], [Jhat_lofi; Jhat_std_oed], ".-", "Color", "#1F618D", "DisplayName", "Updated Sols");
