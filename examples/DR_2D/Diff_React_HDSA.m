classdef Diff_React_HDSA < HDSA_Abesa_MD_Interface_Elliptic_Prior
    ...
    methods
        function obj = Diff_React_HDSA(con_opt_obj,alpha_u,alpha_z)
            ...
            S = con_opt_obj.diff_react_lofi.pde_meshing.S;
            obj.M = con_opt_obj.diff_react_lofi.pde_meshing.M;
            
            obj.E_u = (1.e-1)*S + obj.M;
            
            obj.E_z = (1.e-1)*S + obj.M; %(1.e-3)*S + obj.M;
            
            obj.E_d = (325)*( (1.e-8)*S + obj.M );
