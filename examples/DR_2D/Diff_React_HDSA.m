classdef Diff_React_HDSA < HDSA_Sabl_MD_Interface_Elliptic_Prior
    ...
    methods
        ...
        function this = Diff_React_HDSA(con_opt_obj, alpha_u, alpha_z)
            this@HDSA_Sabl_MD_Interface_Elliptic_Prior(con_opt_obj, alpha_u, alpha_z);

            S = con_opt_obj.con.diff_react_lofi.pde_meshing.S;
            this.M = con_opt_obj.con.diff_react_lofi.pde_meshing.M;

            this.E_u = (1.e-1) * S + this.M;

            this.E_z = (1.e-1) * S + this.M; % (1.e-3)*S + this.M;

            this.E_d = (325) * ((1.e-8) * S + this.M);
