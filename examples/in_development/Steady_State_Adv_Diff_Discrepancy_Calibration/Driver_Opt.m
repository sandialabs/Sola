...
if xi == 1
    ...
    z_lofi = load('Optimization_Results_xi_1.mat', 'z_lofi').z_lofi;
    u_lofi = load('Optimization_Results_xi_1.mat', 'u_lofi').u_lofi;
    Z = load('Optimization_Results_xi_1.mat', 'Z').Z;
...
save(['Optimization_Results_xi_', num2str(xi), '.mat'], 'm', 'vel_coeff', 'reg_coeff', 'z_lofi', 'u_lofi', 'xi', 'Z', 'D');
