...
classdef Mass_Spring_Objective_LoFi < Dynamic_Objective
    ...
    properties
        reg_coeff
        P_z
        mass_spring_obj_hifi
    end

    methods

        function this = Mass_Spring_Objective_LoFi(mass_spring_obj_hifi)
            n_y = 4;
            n_z = 1;
            ...
            this.mass_spring_obj_hifi = mass_spring_obj_hifi;
        end
        ...
        function [val] = target(this, t)
            val = this.mass_spring_obj_hifi.target(t);
        end
