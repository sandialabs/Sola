...
ylim([-r, r]);
set(gca, 'fontsize', 20);
exportgraphics(gcf, 'z_t_xi_12_corr.eps', 'BackgroundColor', 'none', 'ContentType', 'vector');
...
ylim([-r, r]);
set(gca, 'fontsize', 20);
exportgraphics(gcf, 'z_t_xi_13_corr.eps', 'BackgroundColor', 'none', 'ContentType', 'vector');
