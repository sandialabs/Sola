...
ensemble_weighting = MD_OUU_Ensemble_Weighting_Matrix(md_ouu_data_interface, us_prior_interface, 0.0, 0.0, true);
...
plot(x, discrepancy_z1(:, xi1) - discrepancy_z1(:, xi2), "Color", 'magenta', 'LineWidth', 3);
legend({'$(S(z_1,\xi_1)-\tilde{S}(z_1,\xi_1))-(S(z_1,\xi_2)-\tilde{S}(z_1,\xi_2))$', '$\Delta(z_1,\xi_1,\vartheta)-\Delta(z_1,\xi_2,\vartheta)$'}, 'Interpreter', 'latex');
ylim([-r, r]);
set(gca, 'fontsize', 20);
% exportgraphics(gcf, 'z_1_xi_12.eps', 'BackgroundColor', 'none', 'ContentType', 'vector');
...
plot(x, discrepancy_z1(:, xi1) - discrepancy_z1(:, xi3), "Color", 'magenta', 'LineWidth', 3);
legend({'$(S(z_1,\xi_3)-\tilde{S}(z_1,\xi_3))-(S(z_1,\xi_3)-\tilde{S}(z_1,\xi_3))$', '$\Delta(z_1,\xi_1,\vartheta)-\Delta(z_1,\xi_3,\vartheta)$'}, 'Interpreter', 'latex');
ylim([-r, r]);
set(gca, 'fontsize', 20);
% exportgraphics(gcf, 'z_1_xi_13.eps', 'BackgroundColor', 'none', 'ContentType', 'vector');
...
plot(x, discrepancy_z3(:, xi1) - discrepancy_z3(:, xi2), "Color", 'magenta', 'LineWidth', 3);
legend({'$(S(z_t,\xi_1)-\tilde{S}(z_t,\xi_1))-(S(z_t,\xi_2)-\tilde{S}(z_t,\xi_2))$', '$\Delta(z_t,\xi_1,\vartheta)-\Delta(z_t,\xi_2,\vartheta)$'}, 'Interpreter', 'latex');
ylim([-r, r]);
set(gca, 'fontsize', 20);
exportgraphics(gcf, 'z_t_xi_12.eps', 'BackgroundColor', 'none', 'ContentType', 'vector');
...
plot(x, discrepancy_z3(:, xi1) - discrepancy_z3(:, xi3), "Color", 'magenta', 'LineWidth', 3);
legend({'$(S(z_t,\xi_1)-\tilde{S}(z_t,\xi_1))-(S(z_t,\xi_3)-\tilde{S}(z_t,\xi_3))$', '$\Delta(z_t,\xi_1,\vartheta)-\Delta(z_t,\xi_3,\vartheta)$'}, 'Interpreter', 'latex');
ylim([-r, r]);
set(gca, 'fontsize', 20);
exportgraphics(gcf, 'z_t_xi_13.eps', 'BackgroundColor', 'none', 'ContentType', 'vector');
