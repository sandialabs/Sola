...
% y(t) in R^m
% z in R^n
% We derive off Constraint so that c(u,z)=0 corresponds to the discretization of the ODE system
classdef Dynamic_Constraint < Constraint
    ...
    methods (Access = public)
        function this = Dynamic_Constraint(m,n,T,N)
            ...
            this.time_step_solver_options = optimoptions('fsolve','Display','none','SpecifyObjectiveGradient',true);
            this.verbose = true;
        end
