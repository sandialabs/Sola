...
classdef MD_Laplacian_Like_Operator_Properties < handle
    ...
    methods
        ...
        function [e] = Get_Rectangular_Domain_Laplacian_Like_Operator_Evals(this, beta, nodes)
            ...
            elseif size(nodes, 2) == 2
                ...
                disp('Get_Rectangular_Domain_Laplacian_Like_Operator_Evals error: Dimensions greater than 2 are not supported.');
            end
