classdef MD_OED_DeltaCov_Proj < handle
    ...
    methods
        ...
        function this = MD_OED_DeltaCov_Proj(opt_prob_interface, data_interface, u_prior_interface, z_prior_interface, md_hessian_analysis, oed_interface)
            arguments
        ...
        function this = Offline_Computation(this)
            ...
            this.offline_data.V_scale = 1 / (this.data_interface.z_opt' * this.z_prior_interface.Apply_W_z(this.data_interface.z_opt));
        ...
        function [val, grad] = Evaluate_Posterior_Cov_Trace(this, beta, alpha_d, beta_bar)
            ...
            for i = 1:N
                ...
                y_P_y(i) = this.covar_coeff * (tmp' * tmp) * this.offline_data.V_scale;
            ...
            for i = 1:N
                ...
                grad_yPyi = this.covar_coeff * Mg_jac{i}' * (2 * this.offline_data.Vt_Mz_Wz_inv_Mz_V' * (this.offline_data.Vt_Mz_Wz_inv_Mz_V * Mg(:, i))) * this.offline_data.V_scale; % old
