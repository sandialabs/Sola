classdef MD_Transient_Prior_Covariance_Sabl < MD_Transient_Prior_Covariance
    ...
    methods
        ...
        function this = MD_Transient_Prior_Covariance_Sabl(beta_tu, beta_iu, beta_td, T, n_t, n_y)
            h = T / (n_t - 1);
            ...
            this@MD_Transient_Prior_Covariance(beta_tu, beta_iu, beta_td, M_t, S_t, n_y);
            num_evals = n_t;
            oversampling = 20;
